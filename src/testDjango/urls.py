...
from testDjango.strOutToResponse.views import hello,current_time,plustime,plusdays
from testDjango.template.views import current_time,current_ttime ,render_res_current_time,plus_days
